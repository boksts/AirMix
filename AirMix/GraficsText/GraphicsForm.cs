...
namespace AirMix {
    public partial class GraphicsForm : Form {
        ...
        public GraphicsForm(int X, int Y, bool speeds, bool temp, int scale = 50) {
            this.X = X;
            this.Y = Y;
            this.scale = scale;
            this.temp = temp;
        ...
        public bool DrawDisplay(double[,] Ux, double[,] Uy, double [,] Temp, float x0, float len) {
            this.Temp = Temp;
            g.Clear(Color.White);
            DoubleBuffered = true;
        ...
        bool DrawSpeeds(double[,] Ux, double[,] Uy, float x0, float len) {
